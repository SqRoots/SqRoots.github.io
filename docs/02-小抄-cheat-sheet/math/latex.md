...
|  21 | 类字母符号及常数 | `\Im, \imath, \jmath, \Bbbk, \ell, \mho, \wp, \Re, \circledS, \text{§}, \text{¶}, \AA`                                                                                      | $\Im, \imath, \jmath, \Bbbk, \ell, \mho, \wp, \Re, \circledS, \text{§}, \text{¶}, \AA$                                                                                      |
...
|  93 | 特殊符号     | `\amalg \text{¶} \text{§} \% \dagger \ddagger \ldots \cdots`                                                                                                                | $\amalg \text{¶} \text{§} \% \dagger \ddagger \ldots \cdots$                                                                                                                |
